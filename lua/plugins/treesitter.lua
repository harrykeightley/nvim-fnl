...
local ensure_installed = {"bash", "fish", "vim", "vimdoc", "clojure", "commonlisp", "dockerfile", "fennel", "html", "java", "javascript", "typescript", "tsx", "astro", "json", "lua", "markdown", "yaml", "python", "latex"}
local function _2_()
