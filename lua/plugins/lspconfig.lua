...
local server_settings = {lua_ls = {settings = {Lua = {completion = {callSnippet = "Replace"}}}}, ruff = {}, pyright = {settings = {pyright = {disableOrganizeImports = true}}}, ts_ls = {}, tailwindcss = {}, fennel_language_server = {}, gdscript = {}}
