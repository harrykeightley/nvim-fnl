...
return plugin("stevearc/conform.nvim", {keys = {plugin_keys("<leader>f", _5_, {mode = "", desc = "[F]ormat buffer"})}, opts = {notify_on_error = true, formatters_by_ft = {lua = {"stylua"}, fennel = {"fnlfmt"}, python = {"ruff_format"}, typescript = {"prettierd", "prettier", "eslint_d"}, javascript = {"prettierd", "prettier", "eslint_d"}, typescriptreact = {"prettierd", "eslint_d"}, gdscript = {"gdformat"}}}, lazy = false})
